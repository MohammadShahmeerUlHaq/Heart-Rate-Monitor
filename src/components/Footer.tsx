...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#111927] border-t border-gray-800 px-4 py-4">
      <div className="flex flex-wrap items-center justify-between max-w-7xl mx-auto gap-y-4">
        {/* Logo */}
        ...
        {/* Class Stats */}
        <div className="flex flex-wrap items-center justify-center gap-8 flex-1 min-w-0">
          {/* Blue Points */}
